...
# 登入Audience Manager管理 {#log-in-to-audience-manager-admin}
...
1. 瀏覽至下列[!DNL Admin]以存取Audience Manager [!DNL URL]工具： [https://admin.demdex.com/](https://admin.demdex.com/)。
