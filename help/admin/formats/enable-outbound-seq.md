...
# 為傳出檔案啟用Hadoop序列檔案傳輸 {#enable-hadoop-sequence-file-transfers-for-outbound}

您可以為Audience Manager客戶啟用二進位[!DNL Hadoop Sequence Files] ([!DNL SEQ])傳出批次傳輸。

若要啟用[!DNL SEQ]傳出檔案傳輸：

1. 選取您要啟用[!DNL SEQ]傳出檔案傳輸的公司和目的地。
...
1. 按一下頁面底部的&#x200B;**[!UICONTROL Save]**&#x200B;以確認。 客戶現在可以傳送Hadoop序列檔案至目的地。
