...
# API需求與Recommendations {#api-requirements-and-recommendations}
...
建議您建立個別的技術使用者帳戶來使用Audience Manager[!DNL API]。這是一般帳戶，不會繫結至使用者端組織中的特定使用者或與其相關聯。 此型別的[!DNL API]使用者帳戶有助於完成2件事：
