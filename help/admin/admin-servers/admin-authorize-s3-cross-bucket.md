...
我們可以提供給客戶的替代方案是[!UICONTROL Cross-Account Bucket Permissions]中的[!DNL Amazon S3]。 此程式在[AWS檔案](https://docs.aws.amazon.com/AmazonS3/latest/dev/example-walkthroughs-managing-access-example2.html)中說明。 若要在Audience Manager中啟用此替代方案，請遵循下列步驟：

1. 移至&#x200B;**[!UICONTROL Servers]**&#x200B;並選取&#x200B;**[!UICONTROL Create Server]**。
1. 在&#x200B;**[!UICONTROL S3]**&#x200B;下拉式遮罩中選取&#x200B;**[!UICONTROL Protocol/Credentials]**。
1. 核取&#x200B;**[!UICONTROL Use Internal Adobe Key]**&#x200B;選項。
1. 在[!DNL Amazon S3]中使用您客戶的帳戶和貯體名稱。
1. 請確定您的客戶白名單中[!DNL Amazon S3]儲存貯體上的`975822914085`帳戶[!DNL S3]。
