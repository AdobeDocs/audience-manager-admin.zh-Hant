...
2. 填寫欄位:
   ...
   * **[!UICONTROL IMS ID]：**&#x200B;指定您的網際網路傳訊服務識別碼。
   * **[!UICONTROL User Roles]：**&#x200B;選取想要的使用者角色：
      * **[!UICONTROL DEXADMIN]：**&#x200B;提供管理員存取權，以便在Audience Manager管理工具中執行工作。 如果您未選取此選項，您可以選擇個別角色。 這些角色可讓使用者使用[!DNL API]呼叫執行工作，但無法在管理員工具中執行。
      * **[!UICONTROL CREATE_USERS]：**&#x200B;可讓使用者使用[!DNL API]呼叫建立新的使用者。
